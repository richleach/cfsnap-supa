          ...
          <div className="p-0 pb-12 mb-8 bg-white rounded-lg shadow-lg md:p-4">
            <div className="grid grid-cols-1 gap-4 align-middle">
              ...
              <div className="inline-block p-0 pb-0 mb-1 align-middle bg-white rounded-lg shadow-lg sm:p-8">
                <h2 className="p-2 pb-0 mb-2 font-semibold text-center text-md md:text-2xl sm:align-middle">
                  I checked everywhere....
                </h2>
                <br />
                <br />
                My other jacket, the pants I wore yesterday... I even jiggled
                the handle. <br />
                <br />
                I can't find the page you're looking for.
                <br />
                <br />
                Without further ado, here is your well earned <br />
                <br />
                <h2 className="p-2 pb-0 mb-0 font-semibold text-center text-md md:text-2xl sm:align-middle">
                  404 error message.
                </h2>
                <br />
                <br />
                I feel outright misguided, turned around and devoid of a logical
                next step and have no idea what to do next. There are some links
                on this page, why not give one of them a try?
                <br />
                <br />
              </div>
            </div>
