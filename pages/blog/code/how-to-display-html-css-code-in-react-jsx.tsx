  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="At some point in your career you're going to need to print/display/present code. This is an easy way to display code in your JSX output."
        />
        <meta
          name="keywords"
          content="Display code in JSX, output code in JSX, how do I output CSS code in my JSX"
        />
      </Head>
          ...
          <div className="col-span-1 lg:col-span-8">
            <div className="p-0 pb-12 mb-8 bg-white rounded-lg shadow-lg md:p-4">
              ...
              <div className="relative flex justify-center overflow-hidden mb-7 place-items-center ">
                <img
                  src="/images/code/codeCover.jpg"
                  alt="Display HTML/CSS code in React"
              ...
              {/* POST STARTS HERE */}
              <p className="mb-8">
                Did you ever need to output HTML, CSS or Javascript to the
                screen from a React JSX(TSX) component? I simply pre-build the
                code string outside/above the return() statement in my
                component. The secret sauce is to wrap the desired code string
                in back-ticks - see screenshot above.
              </p>
