    ...
    <div className="container px-10 mx-auto mb-8">
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-12">
        <div className="col-span-1 sm:col-span-8">
            ...
            <div className="grid grid-cols-1 gap-4 align-middle">
              <div className="inline-block p-0 pb-0 mb-1 align-middle bg-white rounded-lg shadow-lg sm:p-2 ">
                <p className="p-2 pb-0 mb-0 font-semibold text-center text-md md:text-3xl sm:align-middle">
                  Portfolio - Projects and Goodies
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            className="p-4 pb-12 mb-8 bg-white rounded-lg shadow-lg"
            style={{
              backgroundImage: 'url("../images/lotteryNumbers.png")',
              ...
              <div className="showcase-form card">
                <div className="grid grid-cols-1 gap-4 mb-4">
                  <Link href={`/portfolio/lotterySimulator`}>
                    ...
                    An oldie but goodie! Play the lottery (virtually, of
                    course).
                  </Link>
                </div>
              </div>
            ...
            <div className="container">
              <div className="showcase-form card">
                <div className="grid grid-cols-1 gap-4">
                  ...
                  More projects and goodies are on the way...
                </div>
              </div>
            </div>
          </div>
